...
export default function Resume(){
    return <section id='resume' className='flex flex-col md:flex-row bg-primary px-5 py-0'>
        ...
        <div className='md:w-1/2 flex justify-center'>
            ...
            <h1 className='text-4xl border-b-4 border-primary mb-5 w-[145px] font-bold'>RESUME</h1>
             <p className='pb-5'>YOU CAN VIEW MY RESUME <a href="/resume.pdf" className="btn" download>Download</a></p>
